...
const ProfilePage = () => {
  ...
  return (
    <div className="font-inter">
      ...
      <div className="bg-[#1E1F23] p-4 sm:p-6 md:p-8 md:py-13 rounded-lg text-white flex flex-col md:flex-row md:justify-between gap-6">
        <div className="flex items-center md:w-3/5">
          <div className="mr-3 shrink-0">
            <Image
              ...
              width={300}
              height={300}
              className="w-20 h-20 sm:w-26 sm:h-26 m-auto object-cover rounded-lg"
            />
          </div>
          <div className="flex-1 gap-2 min-w-0">
            <h1 className="text-2xl sm:text-3xl md:text-6xl mb-2 text-white font-extrabold truncate">{displayName}</h1>
            <div className="flex flex-wrap gap-x-4 gap-y-1">
              <div className="flex">
                <History size={15} className="mr-2 shrink-0" />
              ...
              <div className="flex">
                <Headphones size={15} className="mr-2 shrink-0" />
                <p className="font-semibold text-xs">
